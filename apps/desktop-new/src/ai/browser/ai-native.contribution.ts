...
export class AINativeContribution implements ComponentContribution, AINativeCoreContribution, ClientAppContribution {
  ...
  registerChatFeature(registry: IChatFeatureRegistry): void {
    registry.registerWelcome(
      ...
      Hi! I'm your AI coding assistant. I'm here to answer questions about your code and help you think through problems.</br>Feel free to ask me anything about your codebase!`),
      [
        {
    ...
    registry.registerTerminalInlineChat(
      {
        id: 'terminal-explain',
        name: 'Explain',
        title: 'Explain selected content'
      },
      {
    ...
    registry.registerTerminalInlineChat(
      {
        id: 'terminal-debug',
        name: 'debug',
        title: 'Analyze selected content'
      },
      {
        triggerRules: [
          NodeMatcher,
...
\`\`\`
        ...
        Please fix the code based on the lint error message!
        No explanation needed, just return the fixed code block content`;
