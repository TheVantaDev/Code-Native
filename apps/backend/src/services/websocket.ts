...
export function setupWebSocket(io: SocketIOServer) {
    io.on('connection', (socket: Socket) => {
        ...
        // In this implementation, the BACKEND is the authoritative source of truth
        // for the file content inside a collaboration room.
        //
        // How it works:
        ...
        // * If two users edit the same line at the same time, the edit that reaches
        //   the backend LAST will overwrite the previous one.
        // * This is called a "last-write-wins" strategy.
        //
        // Future Improvement:
        // * For true conflict resolution and simultaneous editing support,
        //   we will upgrade to a CRDT-based system (e.g., Yjs).
